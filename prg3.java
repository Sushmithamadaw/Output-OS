...
<html>
    <head>
        <title>Get Method call</title>
        <meta charset="UTF-8">
        <meta name="viewport" content="width=device-width, initial-scale=1.0">
    </head>
    <body>
        <div>
            <form name="form1" action="colorGet" method="GET">
                <center><b>COLOR</b>
                    <select name="combobox1" size="1">
                        <option name="yellowGreen">Yellow Green</option>
 ...
 * @author mcacnj
 */
@WebServlet(urlPatterns = {"/colorGet"})
...
<html>
    ...
    <body>
        <div>
            <form name="form2" action="colorPost" method="POST">
                <center><b>COLOR</b>
                    <select name="combobox2" size="1">
                        <option name="yellowGreen">Yellow Green</option>
                        <option name="violet">Violet</option>
                         <option name="red">Red</option>
                         <option name="blue">Blue</option>
...
//        processRequest(request, response);
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
       String value=request.getParameter("combobox2");
      response.setContentType("text/html");
      PrintWriter out=response.getWriter();
      out.println("<body bgcolor="+value+"text=white");
      out.println("<center><h2>The Selected color is"+value);
